            ...
            <div class="modal-body px-0 py-2 py-sm-0">
                ...
                <div class="row mx-0 align-items-center">
                    <div class="col-md-6 border-end-md p-4 p-sm-5">
                        <h2 class="h3 mb-4 mb-sm-5">Hey there!
                            <br>Welcome back.
                        </h2>
                        ...
                        <div class="mt-4 mt-sm-5">Don't have an account?
                            <a href="#signup-modal" data-bs-toggle="modal" data-bs-dismiss="modal">Sign up here
                            </a>
                        </div>
                    </div>
                    <div class="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5">
                        ...
                        {!! Form::open(['route' => 'login', 'method' => 'POST', 'class' => 'needs-validation','novalidate' ]) !!}
                        <div class="mb-4">
                            <label class="form-label mb-2" for="signin-email">Email address</label>
                            {!! Form::email('email', old('email'), ['id' => 'signin-email', 'class' => 'form-control', 'placeholder' => 'Enter your email' , 'required','autocomplete' => 'email']) !!}
                            @error('email')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="password-toggle">
                                {!! Form::password('password',['id' => 'signin-password', 'class' => 'form-control','required','autocomplete' => 'current-password']) !!}
