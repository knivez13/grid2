...
<div class="row">
    ...
    <div class="col-lg-8 col-md-7 mb-5">
        ...
        <div class="row mb-2">
            <div class="col-sm-7">
                <a href="{{ route('property-status.create') }}" class="btn btn-outline-info btn-sm mb-2"><i class="fi-plus me-2"></i>Create</a>
            </div>
            <div class="col-sm-5">
                {!! Form::open(['route' => 'property-status.index', 'method' => 'GET']) !!}
        ...
        @include('realstate.propertystatus.list')
    </div>
