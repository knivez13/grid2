...
<div class="row">
    ...
    <div class="col-lg-8 col-md-7 mb-5">
        <h1 class="h2">Near Location Edit</h1>
        @include('components.alert')
        {!! Form::open(['route' => ['near-location.update', $data->id], 'method' => 'PATCH',]) !!}
        ...
        <div class="mb-0 col-md-6">
            ...
            <a href="{{ route('near-location.index') }}" class="btn btn-outline-danger btn-sm mb-2">Cancel</a>
        </div>
        {!! Form::close() !!}
    </div>
