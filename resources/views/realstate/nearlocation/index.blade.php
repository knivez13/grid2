...
<div class="row">
    ...
    <div class="col-lg-8 col-md-7 mb-5">
        <h1 class="h2">Near Location</h1>
        <div class="row mb-2">
            <div class="col-sm-7">
                <a href="{{ route('near-location.create') }}" class="btn btn-outline-info btn-sm mb-2"><i class="fi-plus me-2"></i>Create</a>
            </div>
            <div class="col-sm-5">
                {!! Form::open(['route' => 'near-location.index', 'method' => 'GET']) !!}
        ...
        @include('realstate.nearlocation.list')
    </div>
